...
SELECT listings.property_type, reviews.COUNT(*), reviews.date_reviewed FROM listings INNER JOIN reviews ON listings.id = reviews.listing_id GROUP BY listings.property_type ORDER BY reviews.date_reviewed DESC;